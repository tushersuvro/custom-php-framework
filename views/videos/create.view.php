                    ...
                    <form id="contactForm" name="storeVideo" action="/videos/store" method="POST" novalidate>
                        <div class="control-group form-group">
                            <div class="controls">
                                ...
                                <input id="title" name="title" type="text" value="<?= $_SESSION['flash']['old']['title'] ?? '' ?>" required class="form-control" >
                        ...
                        <div class="control-group form-group">
                            <div class="controls">
                                ...
                                <textarea name="description" id="description"  class="form-control" required ><?= $_SESSION['flash']['old']['description'] ?? '' ?></textarea>
